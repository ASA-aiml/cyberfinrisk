...
# OpenTelemetry — conditional distributed tracing
...
# OpenTelemetry — wire if enabled
if _otel_enabled:
    resource = Resource(attributes={SERVICE_NAME: "cyberfinrisk-backend"})
    ...
    SQLAlchemyInstrumentor().instrument(
        engine=pg_engine,
        engine_service_name="cyberfinrisk-postgres",
    )
