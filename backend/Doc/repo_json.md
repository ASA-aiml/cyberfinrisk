...
```json
{
  ...
  "repo_url": "https://github.com/plausible/analytics",
  "branch": "master"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/gollum/gollum",
  "branch": "master"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/dotnet/infer",
  "branch": "main"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/osCommerce/osCommerce-V4",
  "branch": "main"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/mojaloop/mojaloop",
  "branch": "main"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/FarmBot/FarmBot-Web-App",
  "branch": "master"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/topics/open-source-healthcare",
  "branch": "main"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/openmrs/openmrs-core",
  "branch": "master"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/ekylibre/ekylibre",
  "branch": "master"
}
```
...
```json
{
  ...
  "repo_url": "https://github.com/Sarvwigyan/sarvwigyan",
  "branch": "main"
}
```
